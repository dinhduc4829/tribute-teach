  ...
  mainContent: [
    {
      ...
      content: "Buổi chiều đầu tiên đi học quả thật là rất đáng nhớ, đó là ngày 23 âm lịch. Từ học python mà nhảy qua cpp thì bọn em như là như mù chữ. Khi đó chẳng ai quen ai, chẳng ai biết ai. Và thầy đã cho chúng em viết những dòng code đầu tiên: cout << “Hello wolrd”;",
    },
    {
      id: 2,
      title: "Những ngày sau Tết",
      subtitle: "Những cấu trúc dữ liệu đầu tiên",
      content: "Qua tết là lúc thầy bắt đầu dạy những kiến thức đầu tiên. Từ số nguyên, số thực, mảng, xâu và hàm. Từ những thuật toán kiểm tra chẵn lẻ, nguyên tố, tìm ước bội… Tất cả bọn em đều nhớ như in những năm tháng ấy. Hôm học về string, thầy đã nói: “Bây giờ mình đi học, còn người ra đi chơi; mình ngồi đây còn người ta thì ở ngoài kia. Chắn chắn mình phải được cái gì đấy hơn họ chứ”. Đến hôm nay thì sự khác biệt ấy đã quá rõ ràng rồi thầy ạ",
    },
    {
      id: 3,
      title: "Những bài toán nhỏ",
      subtitle: "Từng bước, từng dòng code",
      content: "Mỗi bài toán là một thử thách mới. Có những đêm chúng em ngồi code đến 2-3 tiếng liên tục vẫn chưa tìm ra lời giải. Nhưng đến hôm sau, thầy lại kiên nhẫn ngồi cùng, phân tích từng trường hợp, từng edge case. 'Đừng vội kết luận, hãy suy nghĩ kỹ hơn,' thầy thường nói. Thầy dạy chúng em cách debug, cách tư duy từ đơn giản đến phức tạp, cách tối ưu từng dòng code. Những bài toán nhỏ ấy không chỉ rèn luyện kỹ năng, mà còn rèn luyện sự kiên nhẫn, sự tỉ mỉ - những phẩm chất quý báu mà thầy đã truyền cho chúng em.",
    },
    {
      id: 4,
      title: "Ngày đầu làm đề thật",
      subtitle: "Rào cản và bài học đầu tiên",
      content: "Lần đầu tiên cầm đề HSG trên tay, chúng em tự tin. Nhưng 3 tiếng sau, màn hình vẫn trống rỗng, chỉ có vài dòng code lủng củng. Cảm giác thất vọng tràn ngập, chúng em nghĩ mình không đủ năng lực. Nhưng thầy đã nói: 'Thất bại là bước đầu tiên của thành công. Các em đã dám thử, đó là điều quan trọng nhất.' Thầy cùng chúng em phân tích từng câu hỏi, chỉ ra những gì còn thiếu, những gì cần học thêm. Ánh mắt thầy không có sự trách móc, chỉ có niềm tin và sự động viên. Và chúng em hiểu, con đường phía trước còn dài, nhưng có thầy đồng hành, chúng em sẽ vượt qua.",
    },
    {
      id: 5,
      title: "Những đêm khuya",
      subtitle: "Ánh đèn và những dòng feedback",
      content: "Đã bao nhiêu đêm, khi mọi thứ chìm vào giấc ngủ, thầy vẫn thức để sửa code cho chúng em. Những dòng comment chi tiết, những gợi ý tinh tế, những lời động viên ấm áp xuất hiện trong từng dòng tin nhắn zalo. 'Em đã làm tốt phần này, nhưng hãy thử tối ưu thêm ở đây,' thầy viết. Mỗi lần nhận được feedback từ thầy, chúng em lại cảm thấy biết ơn vô cùng. Thầy không chỉ dạy code, thầy dạy chúng em cách làm việc chuyên nghiệp, cách tôn trọng từng dòng lệnh, từng thuật toán. Những đêm ấy, ánh đèn phòng thầy là ngọn hải đăng dẫn lối cho chúng em.",
    },
    {
      id: 6,
      title: "Tài liệu và thuật toán quý",
      subtitle: "Mở rộng chân trời tri thức",
      content: "Thầy luôn tìm kiếm những tài liệu hay nhất, những thuật toán mới nhất để chia sẻ với chúng em. Thế giới thuật toán mở ra rộng lớn và kỳ diệu. Thầy không chỉ dạy công thức, thầy dạy cách tư duy đằng sau mỗi thuật toán, lịch sử ra đời của chúng, ứng dụng thực tế. 'Thuật toán là nghệ thuật' thầy nói. Mỗi tài liệu thầy gửi đều là một món quà tri thức, mở rộng tầm nhìn và khơi dậy đam mê trong chúng em.",
    },
    {
      id: 7,
      title: "Những lần thi thử",
      subtitle: "Điểm số và bài học trưởng thành",
      content: "Thi thử lần một: 9 điểm. Thi thử lần hai: 8 điểm. Thi thử lần ba: 5 điểm. Con số lên xuống thất thường, nhưng thầy luôn bình tĩnh phân tích. 'Điểm số chỉ là con số, quan trọng là các em học được gì từ mỗi lần thi,' thầy nhắc nhở. Mỗi bài thi thử, thầy đều ngồi chấm kỹ càng, chỉ ra từng lỗi sai, từng cách tối ưu hơn. Thầy dạy chúng em cách đối mặt với áp lực, cách giữ bình tĩnh khi gặp bài khó, cách phân bổ thời gian hợp lý. Những lần thi thử ấy không chỉ là bài kiểm tra kiến thức, mà là bài học về sự trưởng thành, về cách vượt qua chính mình.",
    },
    {
      id: 8,
      title: "Còn gần 1 tháng nữa thôi",
      subtitle: "Nỗ lực cuối cùng, quyết tâm không lùi bước",
      content: "Thời gian trôi nhanh, kỳ thi HSG đã cận kề. Mỗi ngày, chúng em code từ sáng đến tối, giải hàng chục bài toán, ôn lại từng thuật toán. Áp lực ngày càng lớn, nhưng động lực cũng ngày càng mạnh mẽ. Chúng em không muốn phụ lòng thầy, người đã dành cả trái tim và tâm huyết cho đội tuyển. 'Các em đã cố gắng rất nhiều, thầy tự hào về các em,' thầy nói trong buổi học cuối cùng trước kỳ thi. Những lời động viên ấy như tiếp thêm sức mạnh, khiến chúng em tin rằng, dù kết quả thế nào, chúng em đã làm hết sức mình, đã không phụ lòng người thầy tận tâm.",
    }
  ],
